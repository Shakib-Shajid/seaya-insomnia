...
const FAQ = () => {
    return (
        //  
        <div className='bg-gradient-to-r from-[#614385] to-[#516395] w-[96%] lg:w-[70%] rounded-3xl mx-auto my-10 pt-5 pb-16' data-aos="flip-left">
            <h3 className='text-3xl md:text-4xl py-10 w-[80%] lg:w-[60%] mx-auto text-white '>Frequently Asked Question</h3>
