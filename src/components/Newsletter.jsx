...
const Newsletter = () => {
    return (
        <div className="text-center relative mx-auto bg-violet-600 text-white md:rounded-3xl p-5 lg:p-10 md:w-[90%] lg:w-[70%] my-10" data-aos="zoom-in">
            ...
            <div className='w-full md:w-[80%] mx-auto'> 
                ...
                <button className="btn bg-error hover:bg-error text-white border-none rounded-full btn-lg lg:absolute lg:bottom-[2.8rem] w-full lg:w-40
