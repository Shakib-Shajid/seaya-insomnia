        ...
        <div className=''>
            ...
            <section className='bg-[#97D4CB]'>
                <div className='md:px-24 md:py-16 w-[80%] mx-auto md:w-full'>
                    ...
                    <p className='text-xl lg:w-2/4 pr-0 md:pr-7 lg:pr-0 my-8 space-y-3'>Insomnia Lab fosters a collaborative environment where brands can connect, learn, and grow together. We leverage our extensive network of mentors, advisors, and industry partners to provide our portfolio companies with the guidance, resources, and connections they need to thrive.</p>
                    <div className='flex items-center'>
                        <GoDash className='inline-block' />
                        <p>Find out more here</p>
                    </div>
